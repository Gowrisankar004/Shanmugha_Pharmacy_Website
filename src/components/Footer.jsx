          ...
          <div className="col-lg-4 col-md-12">
            <div className="footer-quick-links">
              ...
              <div className="footer-content">
                <p>
                  The esteemed hope of SSCOP is to mould the students into proud
                  citizens of this great nation, laying reputation on honing
                  their skills and concentrating on their physiological and
                  spiritual needs. The college possesses contemporary
              ...
              <div className="footer-social-links">
                <ul>
                  <li>
                    <a
                      href="https://youtube.com/@shanmughalive3140"
                      target="_blank"
                      rel="noreferrer"
                    >
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="footer-copyright-text">
                <p>
                  Copyright © 2026 Sri Shanmugha College Of Pharmacy All Rights
                  Reserved.
                </p>
              </div>
            </div>
